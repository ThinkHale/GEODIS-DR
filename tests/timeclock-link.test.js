...
const rows = () => [
  { name: 'Reed, Ava', nameKey: SC.nameKey('Reed, Ava'), wfmId: '80-AREED1', wfmIdSuffix: 'AREED1', badge: '', rosterMatch: '', inPresence: true },
  // Spelled differently in every system -- no rule will ever join this one.
  { name: 'Ortiz-Vega, Benjamin', nameKey: SC.nameKey('Ortiz-Vega, Benjamin'), wfmId: '80-BORTIZ9', wfmIdSuffix: 'BORTIZ9', badge: '', rosterMatch: '', inPresence: true },
  { name: 'Nobody, Here', nameKey: SC.nameKey('Nobody, Here'), wfmId: '80-NOBODY1', wfmIdSuffix: 'NOBODY1', badge: '', rosterMatch: '', inPresence: true }
];
...
t('lowercase id in the report still finds an uppercase link',
  SC.linkRoster([{ name: 'X', nameKey: 'x', wfmId: '80-bortiz9', wfmIdSuffix: 'bortiz9', badge: '', inPresence: true }],
    profiles, norm, SC.linkIndex([{ eid: '80-BORTIZ9', badge: 'b2' }]))[0].badge === 'b2');

console.log('— only people actually on the report count as unlinked —');
